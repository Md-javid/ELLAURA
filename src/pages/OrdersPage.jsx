...
import { ArrowLeft, Package, Truck, CheckCircle, Clock, MapPin, Mail, User, LogOut, ShoppingBag, ChevronRight, Search, RefreshCw } from 'lucide-react'
import { useAuth, useUI } from '../context/AppContext'
import { getUserOrders, signOut } from '../lib/supabase'
          ...
          <div className="space-y-4">
            ...
            <div className="glass-dark rounded-[24px] border border-white/8 p-6">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="font-serif text-lg font-bold text-white/90">Your Profile</h2>
